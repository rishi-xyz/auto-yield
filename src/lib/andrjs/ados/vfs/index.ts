...
import { VfsContractTsQueryMsgBuilder } from "./VfsContractTs.message-builder";

/**
 * Queries for the vfs contract
 */
export namespace VFS {
  export const getUsernameMsg = VfsContractTsQueryMsgBuilder.getUsername;

  export type GetUsernameResponse = string;

  export const resolvePathMsg = VfsContractTsQueryMsgBuilder.resolvePath;
